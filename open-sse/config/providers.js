...
export const PROVIDERS = {
  ...
  requesty: { baseUrl: "https://router.requesty.ai/v1/chat/completions", format: "openai" },
  zenmux: { baseUrl: "https://zenmux.ai/api/v1/chat/completions", format: "openai" },
  dgrid: { baseUrl: "https://api.dgrid.ai/v1/chat/completions", format: "openai" },
  orcarouter: { baseUrl: "https://api.orcarouter.ai/v1/chat/completions", format: "openai" },
  modelscope: { baseUrl: "https://api-inference.modelscope.cn/v1/chat/completions", format: "openai" },
  digitalocean: { baseUrl: "https://inference.do-ai.run/v1/chat/completions", format: "openai" },
  alibaba: { baseUrl: "https://dashscope-intl.aliyuncs.com/compatible-mode/v1/chat/completions", format: "openai" },
  "alibaba-cn": { baseUrl: "https://dashscope.aliyuncs.com/compatible-mode/v1/chat/completions", format: "openai" },
  "bailian-coding-plan": { baseUrl: "https://coding-intl.dashscope.aliyuncs.com/apps/anthropic/v1/messages", format: "claude" },
  hcnsec: { baseUrl: "https://api.hcnsec.cn/v1/chat/completions", format: "openai" },
  glmt: { baseUrl: "https://api.z.ai/api/coding/paas/v4/chat/completions", format: "openai" },
  sparkdesk: { baseUrl: "https://spark-api-open.xf-yun.com/v1/chat/completions", format: "openai" },
  openvecta: { baseUrl: "https://api.openvecta.com/v1/chat/completions", format: "openai" },
  sumopod: { baseUrl: "https://ai.sumopod.com/v1/chat/completions", format: "openai" },
  kenari: { baseUrl: "https://kenari.id/v1/chat/completions", format: "openai" },
  x5lab: { baseUrl: "https://api.x5lab.dev/v1/chat/completions", format: "openai" },
  wafer: { baseUrl: "https://pass.wafer.ai/v1/messages", format: "claude" },
  nube: { baseUrl: "https://ai.nube.sh/api/v1/chat/completions", format: "openai" },
  qiniu: { baseUrl: "https://api.qnaigc.com/v1/chat/completions", format: "openai" },
  factory: { baseUrl: "https://api.factory.ai/v1/chat/completions", format: "openai" },
  openadapter: { baseUrl: "https://api.openadapter.in/v1/chat/completions", format: "openai" },
  pioneer: { baseUrl: "https://api.pioneer.ai/v1/chat/completions", format: "openai" },
  "charm-hyper": { baseUrl: "https://hyper.charm.land/v1/chat/completions", format: "openai" },
  dit: { baseUrl: "https://api.dit.ai/v1/chat/completions", format: "openai" },
  bai: { baseUrl: "https://api.b.ai/v1/chat/completions", format: "openai" },
  "v0-vercel": { baseUrl: "https://api.v0.dev/v1/chat/completions", format: "openai" },
  "codebuddy-cn": { baseUrl: "https://copilot.tencent.com/v2/chat/completions", format: "openai" },
  "kimi-coding-apikey": { baseUrl: "https://api.kimi.com/coding/v1/messages", format: "claude" },
  theoldllm: { baseUrl: "https://theoldllm.vercel.app/api/chatgpt", format: "openai", noAuth: true },
  mimocode: { baseUrl: "https://api.xiaomimimo.com/v1/chat/completions", format: "openai", noAuth: true },
  auggie: { baseUrl: "https://api.augmentcode.com/v1/chat/completions", format: "openai", noAuth: true },
  "zenmux-free": { baseUrl: "https://zenmux.ai/api/anthropic/v1/messages", format: "claude" },
  "veoaifree-web": { baseUrl: "https://veoaifree.com/api/generate", format: "openai", authType: "none", noAuth: true },
  "yuanbao-web": { baseUrl: "https://yuanbao.tencent.com/api/chat", format: "openai", authType: "cookie" },
  "zai-web": { baseUrl: "https://chat.z.ai/api/chat", format: "openai", authType: "cookie" },
  "qwen-web": { baseUrl: "https://chat.qwen.ai/api/chat", format: "openai", authType: "cookie" },
  "copilot-m365-web": { baseUrl: "https://m365.cloud.microsoft/chat", format: "openai", authType: "cookie" },
  lmarena: { baseUrl: "https://arena.ai/api/chat", format: "openai", authType: "cookie" },
