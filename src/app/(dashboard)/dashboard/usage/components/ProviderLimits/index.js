...
import { USAGE_SUPPORTED_PROVIDERS, USAGE_APIKEY_PROVIDERS, getProviderIconPath, getProviderIconSources } from "@/shared/constants/providers";
            ...
            >
              <span className="flex min-w-0 items-center gap-1.5">
                {providerFilter === "all" ? (
                  ...
                  <ProviderIcon
                    src={getProviderIconSources(providerFilter)}
                    alt={providerFilter}
                    size={18}
                ...
                <div className="flex items-center justify-between gap-2">
                  <div className="flex items-center gap-2 min-w-0">
                    <div className="w-8 h-8 shrink-0 rounded-md flex items-center justify-center overflow-hidden">
                      <ProviderIcon
                        src={getProviderIconSources({
                          id: conn.provider,
                          provider: conn.provider,
                          name: conn.name,
                          baseUrl: conn.providerSpecificData?.baseUrl,
                          prefix: conn.providerSpecificData?.prefix,
                        }, getProviderIconPath(conn.provider))}
                        alt={conn.provider}
                        size={32}
