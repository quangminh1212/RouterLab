  ...
  return (
    <section className="py-24 border-y border-[#3a2f27] bg-[#23180f]/30" id="how-it-works">
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">How XLab Router Works</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          {/* Connection line */}
          <div className="hidden md:block absolute top-12 left-[16%] right-[16%] h-[2px] bg-linear-to-r from-gray-700 via-[#187878] to-gray-700 -z-10"></div>
          ...
          {/* Step 2: xlabrouter Hub */}
          <div className="flex flex-col gap-6 relative group md:items-center md:text-center">
            <div className="w-24 h-24 rounded-2xl bg-[#181411] border-2 border-[#187878] flex items-center justify-center shadow-[0_0_30px_rgba(24,120,120,0.2)] z-10 mx-auto">
              <span className="material-symbols-outlined text-4xl text-[#187878] animate-pulse">hub</span>
            </div>
            <div>
              <h3 className="text-xl font-bold mb-2 text-[#187878]">2. XLab Router Hub</h3>
              <p className="text-sm text-gray-400">
