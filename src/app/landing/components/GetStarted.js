        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-400 text-lg mb-8">
              Install XLab Router, configure your providers via web dashboard, and start routing AI requests.
            </p>
            
            <div className="flex flex-col gap-6">
              <div className="flex gap-4">
                <div className="flex-none w-8 h-8 rounded-full bg-[#187878]/20 text-[#187878] flex items-center justify-center font-bold">1</div>
                <div>
                  <h4 className="font-bold text-lg">Install XLab Router</h4>
                  <p className="text-sm text-gray-500 mt-1">Run npx command to start the server instantly</p>
                </div>
              </div>
              
              <div className="flex gap-4">
                <div className="flex-none w-8 h-8 rounded-full bg-[#187878]/20 text-[#187878] flex items-center justify-center font-bold">2</div>
                <div>
              ...
              <div className="flex gap-4">
                <div className="flex-none w-8 h-8 rounded-full bg-[#187878]/20 text-[#187878] flex items-center justify-center font-bold">3</div>
                <div>
            ...
            <div className="rounded-xl overflow-hidden bg-[#1e1e1e] border border-[#3a2f27] shadow-2xl">
              ...
              <div className="p-6 font-mono text-sm leading-relaxed overflow-x-auto">
                <div 
                  ...
                  onClick={() => handleCopy("npx xlabrouter")}
                >
                ...
                <div className="text-gray-400 mb-6">
                  <span className="text-[#187878]">&gt;</span> Starting XLab Router...<br/>
                  <span className="text-[#187878]">&gt;</span> Server running on <span className="text-blue-400">http://localhost:20128</span><br/>
                  <span className="text-[#187878]">&gt;</span> Dashboard: <span className="text-blue-400">http://localhost:20128/dashboard</span><br/>
                ...
                <div className="text-gray-400 text-xs">
                  ...
                  <span className="text-gray-500">  macOS/Linux:</span> ~/.xlabrouter/db.json<br/>
                  <span className="text-gray-500">  Windows:</span> %APPDATA%/xlabrouter/db.json
                </div>
              </div>
            </div>
          </div>
