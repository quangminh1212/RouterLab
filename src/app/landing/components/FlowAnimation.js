...
export default function FlowAnimation() {
  ...
  return (
    <div className="mt-16 w-full max-w-4xl relative h-[360px] hidden md:flex items-center justify-center animate-[float_6s_ease-in-out_infinite]">
      {/* xlabrouter Hub - Center */}
      <div className="relative z-20 w-32 h-32 rounded-full bg-[#23180f] border-2 border-[#187878] shadow-[0_0_40px_rgba(24,120,120,0.3)] flex flex-col items-center justify-center gap-1 group cursor-pointer hover:scale-105 transition-transform duration-500">
        <span className="material-symbols-outlined text-4xl text-[#187878]">
          hub
        </span>
      ...
      <div className="absolute left-0 top-1/2 -translate-y-1/2 flex flex-col gap-7">
        {CLI_TOOLS.map((tool) => (
          ...
          >
            <div className="w-16 h-16 rounded-2xl bg-[#23180f] border border-[#3a2f27] flex items-center justify-center overflow-hidden p-2 hover:border-[#187878]/50 transition-all hover:scale-105">
              <ProviderIcon
                src={tool.image}
                alt={tool.name}
                size={48}
      ...
      {/* SVG Lines from CLI to xlabrouter */}
      <svg
      ...
      {/* SVG Lines from xlabrouter to Providers */}
      <svg
      ...
      >
        <path
          ...
          fill="none"
          stroke={activeFlow === 0 ? "#187878" : "rgb(75, 85, 99)"}
        ...
        <path
          ...
          fill="none"
          stroke={activeFlow === 1 ? "#187878" : "rgb(75, 85, 99)"}
        ...
        <path
          ...
          fill="none"
          stroke={activeFlow === 2 ? "#187878" : "rgb(75, 85, 99)"}
        ...
        <path
          ...
          fill="none"
          stroke={activeFlow === 3 ? "#187878" : "rgb(75, 85, 99)"}
        ...
        {PROVIDERS.map((provider, idx) => (
          <div
            ...
            className={`px-4 py-2 rounded-lg ${provider.color} ${provider.textColor} flex items-center justify-center font-bold text-xs shadow-lg hover:scale-110 transition-all cursor-help min-w-[140px] ${
              activeFlow === idx ? "ring-4 ring-[#187878]/50 scale-110" : ""
            }`}
            title={provider.name}
          >
            {provider.name}
