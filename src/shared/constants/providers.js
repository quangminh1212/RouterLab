...
export const APIKEY_PROVIDERS = {
  ...
  azure: { id: "azure", alias: "azure", name: "Azure OpenAI", icon: "cloud", color: "#0078D4", textIcon: "AZ", website: "https://azure.microsoft.com/en-us/products/ai-services/openai-service", notice: { apiKeyUrl: "https://portal.azure.com/#view/Microsoft_Azure_ProjectOxford/CognitiveServicesHub/~/OpenAI" }, serviceKinds: ["llm", "moderation"], moderationConfig: { baseUrl: "azure", authType: "apikey", authHeader: "api-key", format: "azure", models: [{ id: "text-moderation-latest", name: "Text Moderation Latest" }] }, hasProviderSpecificData: true },
  ...
  cohere: { id: "cohere", alias: "cohere", name: "Cohere", icon: "hub", color: "#39594D", textIcon: "CO", website: "https://cohere.com", notice: { apiKeyUrl: "https://dashboard.cohere.com/api-keys" }, serviceKinds: ["llm", "rerank"], rerankConfig: { baseUrl: "https://api.cohere.com/v2/rerank", authType: "apikey", authHeader: "bearer", format: "cohere", models: [{ id: "rerank-v3.5", name: "Rerank v3.5" }, { id: "rerank-english-v3.0", name: "Rerank English v3.0" }] } },
  ...
  "jina-ai": { id: "jina-ai", alias: "jina", name: "Jina AI", icon: "blur_on", color: "#2563EB", textIcon: "JA", website: "https://jina.ai", notice: { text: "10M free tokens on signup (non-commercial), no credit card required.", apiKeyUrl: "https://jina.ai/?sui=apikey" }, serviceKinds: ["embedding", "rerank"], rerankConfig: { baseUrl: "https://api.jina.ai/v1/rerank", authType: "apikey", authHeader: "bearer", format: "jina", models: [{ id: "jina-reranker-v2-base-multilingual", name: "Jina Reranker v2 Base Multilingual" }] }, embeddingConfig: { baseUrl: "https://api.jina.ai/v1/embeddings", authType: "apikey", authHeader: "bearer", models: [{ id: "jina-embeddings-v3", name: "Jina Embeddings v3", dimensions: 1024 }, { id: "jina-embeddings-v2-base-en", name: "Jina Embeddings v2 Base EN", dimensions: 768 }, { id: "jina-embeddings-v2-base-code", name: "Jina Embeddings v2 Base Code", dimensions: 768 }] } },
