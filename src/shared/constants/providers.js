...
export const APIKEY_PROVIDERS = {
  ...
  cungcapai: { id: "cungcapai", alias: "tammao", name: "TamMao", icon: "smart_toy", color: "#14B8A6", textIcon: "TM", website: "https://cungcapai.io.vn", notice: { text: "Dùng endpoint CungCapAI qua TamMao. Dán API key sk-... và hệ thống sẽ gọi https://api.cungcapai.io.vn/v1.", apiKeyUrl: "https://cungcapai.io.vn" }, passthroughModels: true, modelsFetcher: { url: "https://api.cungcapai.io.vn/v1/models", type: "openai-compatible" } },
