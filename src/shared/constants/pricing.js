...
export const MODEL_PRICING = {
  // === Anthropic / Claude ===
  "claude-opus-4-6":              { input: 15.00, output: 75.00, cached: 1.50,  reasoning: 75.00,  cache_creation: 18.75 },
  "claude-opus-4-5-20251101":     { input: 15.00, output: 75.00, cached: 1.50,  reasoning: 75.00,  cache_creation: 18.75 },
  ...
  "claude-opus-4.5":              { input: 15.00, output: 75.00, cached: 1.50,  reasoning: 75.00,  cache_creation: 18.75 },
  "claude-opus-4.6":              { input: 15.00, output: 75.00, cached: 1.50,  reasoning: 75.00,  cache_creation: 18.75 },
  ...
  "claude-sonnet-4.6":            { input: 3.00,  output: 15.00, cached: 0.30,  reasoning: 15.00,  cache_creation: 3.75  },
  "claude-opus-4-5-thinking":     { input: 15.00, output: 75.00, cached: 1.50,  reasoning: 75.00,  cache_creation: 18.75 },
  "claude-opus-4-6-thinking":     { input: 15.00, output: 75.00, cached: 1.50,  reasoning: 75.00,  cache_creation: 18.75 },
  ...
  "gpt-5.4":                      { input: 0.40,  output: 3.20,  cached: 0.10,  reasoning: 3.20,   cache_creation: 0.40  },
  "gpt-5.4-mini":                 { input: 0.10,  output: 0.80,  cached: 0.025, reasoning: 0.80,   cache_creation: 0.10  },
  "gpt-5.4-nano":                 { input: 0.02,  output: 0.16,  cached: 0.005, reasoning: 0.16,   cache_creation: 0.02  },
  "gpt-5.5":                      { input: 2.00,  output: 16.00, cached: 0.20,  reasoning: 16.00,  cache_creation: 2.00  },
  "gpt-5-codex":                  { input: 1.50,  output: 6.00,  cached: 0.15,  reasoning: 6.00,   cache_creation: 1.50  },
  "gpt-5.1":                      { input: 1.25,  output: 10.00, cached: 0.125, reasoning: 10.00,  cache_creation: 1.25  },
  "gpt-5.1-codex":                { input: 1.50,  output: 6.00,  cached: 0.15,  reasoning: 6.00,   cache_creation: 1.50  },
  "gpt-5.1-codex-mini":           { input: 1.50,  output: 6.00,  cached: 0.15,  reasoning: 6.00,   cache_creation: 1.50  },
  "gpt-5.1-codex-mini-high":      { input: 1.50,  output: 6.00,  cached: 0.15,  reasoning: 6.00,   cache_creation: 1.50  },
  "gpt-5.1-codex-max":            { input: 1.50,  output: 6.00,  cached: 0.15,  reasoning: 6.00,   cache_creation: 1.50  },
  "gpt-5.2":                      { input: 1.25,  output: 10.00, cached: 0.125, reasoning: 10.00,  cache_creation: 1.25  },
  "gpt-5.2-codex":                { input: 1.50,  output: 6.00,  cached: 0.15,  reasoning: 6.00,   cache_creation: 1.50  },
  "gpt-5.3-codex":                { input: 1.50,  output: 6.00,  cached: 0.15,  reasoning: 6.00,   cache_creation: 1.50  },
  "gpt-5.3-codex-xhigh":          { input: 1.50,  output: 6.00,  cached: 0.15,  reasoning: 6.00,   cache_creation: 1.50  },
  "gpt-5.3-codex-high":           { input: 1.50,  output: 6.00,  cached: 0.15,  reasoning: 6.00,   cache_creation: 1.50  },
  "gpt-5.3-codex-low":            { input: 1.50,  output: 6.00,  cached: 0.15,  reasoning: 6.00,   cache_creation: 1.50  },
  "gpt-5.3-codex-none":           { input: 1.50,  output: 6.00,  cached: 0.15,  reasoning: 6.00,   cache_creation: 1.50  },
  "gpt-5.3-codex-spark":          { input: 1.50,  output: 6.00,  cached: 0.15,  reasoning: 6.00,   cache_creation: 1.50  },
  "o1":                           { input: 15.00, output: 60.00, cached: 7.50,  reasoning: 90.00,  cache_creation: 15.00 },
  "o1-mini":                      { input: 3.00,  output: 12.00, cached: 1.50,  reasoning: 18.00,  cache_creation: 3.00  },

  // === Gemini ===
  "gemini-3-flash-preview":       { input: 0.30,  output: 2.50,  cached: 0.075, reasoning: 2.50,   cache_creation: 0.30  },
  "gemini-3-pro-preview":         { input: 1.25,  output: 10.00, cached: 0.31,  reasoning: 10.00,  cache_creation: 1.25  },
  "gemini-3.1-pro-low":           { input: 1.25,  output: 10.00, cached: 0.31,  reasoning: 10.00,  cache_creation: 1.25  },
  "gemini-3.1-pro-high":          { input: 1.25,  output: 10.00, cached: 0.31,  reasoning: 10.00,  cache_creation: 1.25  },
  "gemini-3-flash":               { input: 0.30,  output: 2.50,  cached: 0.075, reasoning: 2.50,   cache_creation: 0.30  },
  "gemini-2.5-pro":               { input: 1.25,  output: 10.00, cached: 0.31,  reasoning: 10.00,  cache_creation: 1.25  },
  "gemini-2.5-flash":             { input: 0.30,  output: 2.50,  cached: 0.075, reasoning: 2.50,   cache_creation: 0.30  },
  "gemini-2.5-flash-lite":        { input: 0.10,  output: 0.40,  cached: 0.025, reasoning: 0.40,   cache_creation: 0.10  },
...
export const PATTERN_PRICING = [
  // --- Codex variants ---
  { pattern: "*-codex-xhigh",   pricing: { input: 1.50,  output: 6.00,  cached: 0.15,  reasoning: 6.00,   cache_creation: 1.50  } },
  { pattern: "*-codex-high",    pricing: { input: 1.50,  output: 6.00,  cached: 0.15,  reasoning: 6.00,   cache_creation: 1.50  } },
  { pattern: "*-codex-max",     pricing: { input: 1.50,  output: 6.00,  cached: 0.15,  reasoning: 6.00,   cache_creation: 1.50  } },
  { pattern: "*-codex-mini-*",  pricing: { input: 1.50,  output: 6.00,  cached: 0.15,  reasoning: 6.00,   cache_creation: 1.50  } },
  { pattern: "*-codex-mini",    pricing: { input: 1.50,  output: 6.00,  cached: 0.15,  reasoning: 6.00,   cache_creation: 1.50  } },
  { pattern: "*-codex-low",     pricing: { input: 1.50,  output: 6.00,  cached: 0.15,  reasoning: 6.00,   cache_creation: 1.50  } },
  { pattern: "*-codex-none",    pricing: { input: 1.50,  output: 6.00,  cached: 0.15,  reasoning: 6.00,   cache_creation: 1.50  } },
  { pattern: "*-codex-spark",   pricing: { input: 1.50,  output: 6.00,  cached: 0.15,  reasoning: 6.00,   cache_creation: 1.50  } },
  { pattern: "codex-*",         pricing: { input: 1.50,  output: 6.00,  cached: 0.15,  reasoning: 6.00,   cache_creation: 1.50  } },
  { pattern: "*-codex",         pricing: { input: 1.50,  output: 6.00,  cached: 0.15,  reasoning: 6.00,   cache_creation: 1.50  } },

  // --- Claude ---
  { pattern: "claude-opus-*",   pricing: { input: 15.00, output: 75.00, cached: 1.50,  reasoning: 75.00,  cache_creation: 18.75 } },
  ...
  { pattern: "gemini-*-flash-lite", pricing: { input: 0.10, output: 0.40, cached: 0.025, reasoning: 0.40,  cache_creation: 0.10 } },
  { pattern: "gemini-*-flash",  pricing: { input: 0.30,  output: 2.50,  cached: 0.075, reasoning: 2.50,   cache_creation: 0.30  } },
  { pattern: "gemini-*-pro",    pricing: { input: 1.25,  output: 10.00, cached: 0.31,  reasoning: 10.00,  cache_creation: 1.25  } },
  { pattern: "gemini-3-*",      pricing: { input: 0.30,  output: 2.50,  cached: 0.075, reasoning: 2.50,   cache_creation: 0.30  } },
  { pattern: "gemini-2.5-*",    pricing: { input: 0.30,  output: 2.50,  cached: 0.075, reasoning: 2.50,   cache_creation: 0.30  } },
  { pattern: "gemini-*",        pricing: { input: 0.30,  output: 2.50,  cached: 0.075, reasoning: 2.50,   cache_creation: 0.30  } },

  // --- GPT (specific trước, chung sau) ---
  { pattern: "gpt-5.5*",        pricing: { input: 2.00,  output: 16.00, cached: 0.20,  reasoning: 16.00,  cache_creation: 2.00  } },
  { pattern: "gpt-5.4*",        pricing: { input: 0.40,  output: 3.20,  cached: 0.10,  reasoning: 3.20,   cache_creation: 0.40  } },
  { pattern: "gpt-5.3-*",       pricing: { input: 1.50,  output: 6.00,  cached: 0.15,  reasoning: 6.00,   cache_creation: 1.50  } },
  { pattern: "gpt-5.2-*",       pricing: { input: 1.25,  output: 10.00, cached: 0.125, reasoning: 10.00,  cache_creation: 1.25  } },
...
export function calculateCostFromTokens(tokens, pricing) {
  ...
  const cachedTokens = tokens.cached_tokens
    ...
    ?? 0;
  const nonCachedInput = hasOpenAiShape
