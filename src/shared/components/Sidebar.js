...
export default function Sidebar({ onClose, initialEnableTranslator = false, initialUpdateInfo = null }) {
  ...
  return (
    <>
      <aside className="flex w-72 flex-col border-r border-black/5 dark:border-white/5 bg-sidebar transition-colors duration-300 min-h-full">
...
Sidebar.propTypes = {
  ...
  initialUpdateInfo: PropTypes.shape({
